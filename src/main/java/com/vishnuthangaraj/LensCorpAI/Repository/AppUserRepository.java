package com.vishnuthangaraj.LensCorpAI.Repository;
...
public interface AppUserRepository extends JpaRepository<AppUser, UUID> {
    ...
    */
    ...
    /*
        ...
        DESCRIPTION         : This function is a custom query method defined within the repository associated
                              with the `AppUser` entity. This function retrieves a user from the database
